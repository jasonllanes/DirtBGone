...
public class UpcomingBookDetails extends AppCompatActivity {
    ...
    DatabaseReference myRef2 = database.getReference("UpcomingUser");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcoming_book_details);
        ...
        btnProof.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dialog builder = new Dialog(UpcomingBookDetails.this);
