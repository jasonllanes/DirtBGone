...
public class UpcomingBooked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcoming_booked);
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("UpcomingUser/" + uid);
            ...
            protected void populateView(View v, Object model, int position) {
                ...
                lvPending.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent = new Intent(UpcomingBooked.this, UpcomingBookDetails.class);
