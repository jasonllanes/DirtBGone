...
public class AdminUpcoming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcoming_pane);
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Upcoming");
            ...
            protected void populateView(View v, Object model, int position) {
                ...
                lvPending.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent = new Intent(AdminUpcoming.this, AdminUpcomingBookDetails.class);
