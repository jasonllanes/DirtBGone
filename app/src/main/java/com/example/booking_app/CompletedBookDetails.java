...
public class CompletedBookDetails extends AppCompatActivity {
    ...
    DatabaseReference myRef2 = database.getReference("CompletedUser");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_book_details);
        ...
        btnProof.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dialog builder = new Dialog(CompletedBookDetails.this);
        ...
        DatabaseReference data = database.getReference( "CompletedUser/" + uid + "/" + id );
